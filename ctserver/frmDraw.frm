...
frmServer.server.SendData "101DC" 'send data to the otherside to clear the picturebox for you and the other person
...
frmServer.server.SendData "101DCL"
End Sub
...
frmServer.server.SendData "DRAW" & draw 'sends a draw protocal followed by the string containing all the info
draw = "" 'clear the string so that it doesnt accumulate
End If
